	...
	<div class="login-area">
		<form action="Employee_login.action" method="post">
			<label> 工&nbsp;&nbsp;号： </label> <input type="text"
				name="employee.sn" /> <label> 密&nbsp;&nbsp;码： </label> <input
				type="password" name="employee.password" /> <label> 验证码： </label> <input
				type="text" name="random" size="6" /> <input type="image"
				src="random.action"
				onclick="changeValidateCode(this); return false;" title="点击图片刷新验证码" />
