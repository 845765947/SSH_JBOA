		...
		<div class="pages">
			...
			<table width="90%" border="0" cellspacing="0" cellpadding="0"
				...
				<tr>
					...
					<td>填&nbsp;写&nbsp;人：<s:property
							value="claimVoucher.creator.name" /></td>
					<td>部&nbsp;&nbsp;门：<s:property
							value="claimVoucher.creator.sysDepartment.name" /></td>
					<td>职&nbsp;&nbsp;&nbsp;&nbsp;位：<s:property
							value="claimVoucher.creator.sysPosition.nameCn" /></td>
				</tr>
				<tr>
					<td>总金额：<s:property value="claimVoucher.totalAccount" /></td>
					<td>填报时间：<s:date name="claimVoucher.createTime"
			...
			<table width="90%" border="0" cellspacing="0" cellpadding="0"
				...
				<s:iterator value="claimVoucher.detailList" id="claimDetail"
					begin="0" status="s">
					<tr>
			...
			<table width="90%" border="0" cellspacing="0" cellpadding="0"
				class="addform-base">
				<s:iterator value="claimVoucher.checkResultList" id="checkResult"
					begin="0" status="s">
					<tr>
						<td width="27%"><s:property
								value="#checkResult.checkEmployee.name" />(<s:property
								value="#checkResult.checkEmployee.sysPosition.nameCn" />)</td>
						<td width="20%">&lt;<s:date name="#checkResult.checkTime"
								format="yyyy-MM-dd HH:mm:ss" /></td>
						<td width="38%">审核：<span class="red"><strong><s:property
										value="#checkResult.result" /></strong></span></td>
					</tr>
					<tr>
						<td>审核意见：<strong><s:property
									value="#checkResult.comment" /></strong></td>
						<td>&nbsp;</td>
						<td>&nbsp;</td>
					</tr>
					<tr>
			...
			<s:form action="checkResult_checkClaimVoucher.action"
				...
				<table width="90%" border="0" cellspacing="0" cellpadding="0"
					...
					<s:hidden id="claimId" name="sn"
						value="%{claimVoucher.nextDeal.sn}" />
					<!--表单提交行-->
					<tr>

						<td colspan="3" class="submit"><input type="button"
							name="button" id="button" value="审批通过" class="submit_01"
							onclick="checkClaimVoucher('通过')" /> <s:hidden id="claimId"
								name="checkResult.claimId" value="%{claimVoucher.id}" /> <s:hidden
								id="result" name="checkResult.result" value="" /> <s:if
								test='#session.employee_position != "财务"'>
