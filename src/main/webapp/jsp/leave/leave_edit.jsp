			...
			<s:form action="leave_saveLeave.action" name="leaveForm"
				...
				<table class="leave">
					<tr>
						...
						<td class="width2"><s:property
								value="%{#session.employee.name}" /></td>
						<td class="width1"><label>部门：</label></td>
						<td class="width2"><s:property
								value="#session.employee.sysDepartment.name" /></td>
					</tr>
					<tr>
				...
				<div class="forms ">
					...
					<p class="marg">
						<input name="button" type="button" value="提交流程" class="submit_01"
							...
							value="取消" class="submit_01" onclick="window.history.go(-1)" />
					</p>
				</div>
			</s:form>
			<!--请假申请 区域 结束-->
